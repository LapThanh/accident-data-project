...
spark_script_bucket_name = 'lapthanh-spark-script'
raw_datalake_bucket_name = 'lapthanh-raw-datalake'
accidents_datalake_bucket_name = 'lapthanh-accidents-datalake'
